...
import com.JJ.controller.productmanagement.vo.ProductAttributeGroupVO;
...
import com.JJ.service.filelinkmanagement.ImageSequenceCompare;
...
import com.JJ.service.productmanagement.ProductTagsService;
...
public class NewProductManagementController {
	private static final Logger logger = Logger.getLogger(NewProductManagementController.class);
	...
	@Autowired
	public NewProductManagementController(ProductMgmtService productMgmtService,
	...
	public @ResponseBody List<FileMetaVO> getPreUploadImage(HttpSession session) {
		...
		newProduct.setImages(NewImageService.convertImageLinkVOToFileMetaVO(newProduct.getImagesLink()));
