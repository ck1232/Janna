...
public class ProductMgmtService {
	...
	private ProductTagsMgmtService productTagsMgmtService;
	...
	public ProductMgmtService(ProductDAO productDAO, 
			...
			ProductTagsMgmtService productTagsMgmtService,
		...
		this.productTagsMgmtService = productTagsMgmtService;
	...
	public void saveAddProduct(ProductVO newProductVO){
		...
		//product tags
		productTagsMgmtService.setProductTagsTO(newProductVO.getTags(), newProductTO);
		
		//product info
		productSpecificationMgmtService.setProductSpecification(newProductVO.getProductInfo(), newProductTO);
		
		//image
		newProductVO.setImagesLink(NewImageService.convertFileMetaVOListToImageLinkVOList(newProductVO.getImages(), GeneralUtils.TYPE_PRODUCT));
