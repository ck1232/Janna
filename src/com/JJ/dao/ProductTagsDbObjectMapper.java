...
public interface ProductTagsDbObjectMapper {
	...
	int updateByExampleSelective(@Param("record") ProductTagsDbObject record,
			@Param("example") ProductTagsDbObjectExample example);

	int updateByExample(@Param("record") ProductTagsDbObject record,
			@Param("example") ProductTagsDbObjectExample example);
