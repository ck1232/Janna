...
public interface ProductoptionMapper {
	...
	int updateByExampleSelective(@Param("record") Productoption record,
			@Param("example") ProductoptionExample example);

	int updateByExample(@Param("record") Productoption record,
			@Param("example") ProductoptionExample example);
